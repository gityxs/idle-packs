...
var cnItems = {
    ...
    "Unicorn Horn": "独角兽的角",
    "+30% per Ancient item": "每件远古物品+30%",
    "Chimera Heart": "奇美拉之心",
    "Mythical fusion: +52% item value": "神话融合：增加52%的物品价值",
    "Techno-Pharaoh's Crown": "法老的王冠",
    "Triple essence: +55% coin production": "三重精华：增加55%的金币产量",
    "+15% per Rick item": "每件叠加物品+15%",
    "+40% per Ancient item": "每件远古物品+40%",
    "Anubis' Ankh": "阿努比斯的十字章",
    "Atlantean Pearl": "亚特兰提斯珍珠",
    "Cyber-Sphinx Core": "赛博-斯芬克斯核心",
    "Holographic Temple Relic": "全息神殿遗物",
    "Ancient treasure: +50% item value": "远古宝藏：+50%物品价值",
    "Lost wisdom: +60% coin production": "失落的智慧：增加60%的金币产量",
    "+20% when equipped with Eye of Horus Amulet": "当装备荷鲁斯之眼护身符时+20%",
    "Nefertiti's Crown": "奈费尔提蒂的皇冠",
    "+10% per Egg or Mystical item": "每个蛋或神秘物品+10%",
    "+10% per Psychic item": "每个灵媒物品+10%",
    "+15% when equipped with Dracelium": "装备龙兽时+15%",
    "+25% per Colony item": "每个殖民地物品+25%",
    "+5% when equipped with 2+ Morty or Fakemon items": "装备2件以上莫蒂或假魔物品时+5%",
    "Digital Ankh of Immortality": "不朽的数字十字章",
    "Divine rule: +62% coin production": "神圣法则：增加62%的金币产量",
    "Egg": "蛋",
    "Galactic Portal": "银河传送门",
    "Infinity Ant": "无限蚂蚁",
    "Mystdrical": "神秘",
    "Prismatic value: +40% item value": "棱柱价值：+40%物品价值",
    "Psychic": "灵媒",
    "Rainbow Dracelium": "彩虹龙兽",
    "Rainbow power: +50% coin production": "彩虹能量：增加50%金币产量",
    "Royal treasury: +70% item value": "皇家宝库：+70%物品价值",
    "Virtual Mummy Guardian": "虚拟木乃伊守护者",
    "Auto Opener": "自动开盒器",
    "Auto-Opener": "自动开盒器",
    "Automatically opens Ancient Packs every few seconds": "每隔几秒自动打开远古包",
    "Automatically opens Cyber Packs every few seconds": "每隔几秒自动打开赛博包",
